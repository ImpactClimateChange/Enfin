        ...
        <div className={styles.descriptionBio}>
          ...
          <Container fluid style={{ lineHeight: '32px' }}>
            ...
            <Row debug>
              ...
              <Col debug className={styles.bio}>Abe Miller studies computer science and philosophy at UW Seattle. He is passionate about leveraging the power of modern computing to make a positive impact on society as well as his own self-growth. More than anything else in the world he loves: coffee, puppies, and bicycling.</Col> 
              ...
              <Col debug className={styles.bio}>Chris Hays is a junior studying Computer Science and Political Science at Yale. In his free time, he writes and edits for an on-campus creative nonfiction publication and works a progressive data analytics job. Chris loves reading (especially Jesmyn Ward and James Joyce) and exploring new cities (most recently Minneapolis and Chicago).</Col>
            </Row>
        </Container>
        </div>
      </div>        
